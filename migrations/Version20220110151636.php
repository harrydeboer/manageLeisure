 ...
 */
final class Version20220110151636 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE wine (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, taste_profile_id INT DEFAULT NULL, subregion_id INT NOT NULL, region_id INT NOT NULL, country_id INT NOT NULL, name VARCHAR(255) NOT NULL, type enum(\'red\', \'white\', \'rosé\', \'orange\', \'sparkling\', \'dessert\', \'fortified\') NOT NULL, label_extension VARCHAR(255) NOT NULL, year INT DEFAULT NULL, rating INT NOT NULL, price INT NOT NULL, description LONGTEXT DEFAULT NULL, review LONGTEXT DEFAULT NULL, created_at INT NOT NULL, INDEX IDX_560C6468A76ED395 (user_id), INDEX IDX_560C646884ADE278 (taste_profile_id), INDEX IDX_560C6468C49AA6C (subregion_id), INDEX IDX_560C646898260155 (region_id), INDEX IDX_560C6468F92F3E70 (country_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
